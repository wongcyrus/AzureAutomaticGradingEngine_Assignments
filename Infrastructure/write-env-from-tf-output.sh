...
# Use outputs.json generated by cdktn output
TF_OUTPUTS_FILE="outputs.json"

# Ensure outputs.json is up to date
cdktn output AzureAutomaticGradingEngineGrader --outputs-file outputs.json --outputs-file-include-sensitive-outputs
