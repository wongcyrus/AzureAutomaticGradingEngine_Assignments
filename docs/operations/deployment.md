...
This deployment uses the managed Node API and intentionally has no portal
linked backend. Do not link the grading Function App directly. See
[Static Web Apps API topology](../architecture/static-web-apps-api.md) for the
request flow, security rationale, and verification commands.
...
- [Teacher](../getting-started/teacher.md)
- [Student in the same tenant](../getting-started/student-same-tenant.md)
- [Student in a different tenant](../getting-started/student-cross-tenant.md)

See the [documentation index](../index.md) for all project guides.
...
See the [subscription registration workflow](../guides/subscription-registration.md).
...
- [Student access and roster management](student-access.md)
